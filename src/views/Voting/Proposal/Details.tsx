    ...
    <Card mb="16px">
      ...
      <CardBody>
        <Flex alignItems="center" mb="8px">
          ...
          <LinkExternal href={`${IPFS_GATEWAY}/${proposal.id}`} ml="8px" color="secondary">
            {proposal.id.slice(0, 8)}
          </LinkExternal>
        </Flex>
        <Flex alignItems="center" mb="8px">
          <Text color="textSubtle">{t('Creator')}</Text>
          <LinkExternal href={getBlockExploreLink(proposal.author, 'address')} ml="8px" color="secondary">
            {truncateHash(proposal.author)}
          </LinkExternal>
        </Flex>
        <Flex alignItems="center" mb="16px">
          <Text color="textSubtle">{t('Snapshot')}</Text>
          <LinkExternal href={getBlockExploreLink(proposal.snapshot, 'block')} ml="8px" color="secondary">
            {proposal.snapshot}
          </LinkExternal>
        </Flex>
        <DetailBox p="16px">
